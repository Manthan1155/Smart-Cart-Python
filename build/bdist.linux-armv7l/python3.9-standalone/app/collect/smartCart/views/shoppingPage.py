...
class ShoppingPage(tk.Tk):
    ...
    def __init__(self):
        ...
        self.priceArray=[]
        self.itemCodeArray=[]
        self.lblItemsInTheCart = tk.Label(text="Items in the cart", background="#353839", foreground="white").grid(row="0",column="0",columnspan=4)
        ...
        self.btnClearAll = tk.Button(self, text="Clear All Items", background = "#a1caf1", command = lambda : self.clearAllItem()).place(x=200, y=280)
        self.btnRemoveItem = tk.Button(self, text="Remove Item", background = "#a1caf1", command = lambda : self.removeItem()).place(x=50, y=280)
        self.btnHelp = tk.Button(self,text = "Help", background = "#a1caf1",command = lambda : self.helpCall()).place(x=50, y=350)
        self.btnProductMap = tk.Button(self, text="Product Map", background = "#a1caf1", command = lambda : self.productMap()).place(x=200, y=350)
        self.btnFinish = tk.Button(self, text="Finish", background = "#a1caf1", command = lambda : self.paymentPage()).place(x=350, y=350)
